    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-orange-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
      </div>
            ...
            <div className="text-center max-w-2xl mx-auto">
              ...
              <div className="mb-8 sm:mb-12">
                <div className="relative inline-block">
                  ...
                  <XCircle className="relative w-20 sm:w-24 md:w-32 h-20 sm:h-24 md:h-32 text-red-500 mx-auto animate-pulse" />
                </div>
              </div>
              ...
              <div className="h-0.5 sm:h-1 w-20 sm:w-32 bg-gradient-to-r from-red-500 to-orange-400 mx-auto mb-6 sm:mb-8 rounded-full"></div>

              {/* Failure Details */}
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-4 sm:mb-6 font-light leading-relaxed px-2">
                Unfortunately, your payment <span className="text-white font-semibold">could not be processed</span>
              </p>
              ...
              <div className="space-y-6 sm:space-y-8">
                <div className="text-center">
                  ...
                  <div className="text-4xl sm:text-5xl font-bold text-orange-400 mb-4">
                    {countdown}
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  >
                    <ArrowLeft className="mr-2 sm:mr-3 w-5 sm:w-6 h-5 sm:h-6 group-hover:-translate-x-1 transition-transform" />
                    Try Again
                  </Button>
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white px-6 sm:px-8 py-3 sm:py-4 text-lg sm:text-xl font-bold transition-all duration-300 hover:scale-105 rounded-xl group"
                  >
